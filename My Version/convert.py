...
def do_convert(args, logdir1, logdir2):
    ...
    # Write the result
    tf.compat.v1.summary.audio('A', y_audio, hp.default.sr, max_outputs=hp.convert.batch_size)
    tf.compat.v1.summary.audio('B', audio, hp.default.sr, max_outputs=hp.convert.batch_size)
